...
O modelo fornece um `Multiple R-squared` de **0.2504**, sendo a proporção da variação explicada pela linha de regressão. Isso significa que aproximadamente **25,04%** da variabilidade da variável dependente é explicada pelas variáveis independentes incluídas no modelo. A análise pode ser feita também, por meio do ` Adjusted Multiple R-squared`. **[valorizar quando os alunos explicarem o conceito R2 = SQE/SQT]**.

**b) Quantos porcento da variabilidade do modelo é explicada pelos resíduos?** (1.0 pt)

Dado que as variáveis independentes explicam, em média, **25,04%** da variabilidade da variável dependente, os resíduos, portanto, explicam **74,96%** do restante, devido à aleatoriedade  e fatores não incluídos no modelo.**[valorizar quando os alunos explicarem o conceito R2 = SQE/SQT]**.
...
**[observar que não solicitei o cálculo/fórmula para estatística F]** 
...
**[reforcei bastante com os alunos o conceito de erro do tipo I, isto é, a chance de erro em rejeitar H0 quando ela é verdadeira]**
...
**[valorizar alunos que tenham apresentado o conceito com equações]**
